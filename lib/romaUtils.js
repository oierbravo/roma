var RomaParamProccessor = function(inParams,outParams){
  var self = this;
  self.functions = {};
  self.functions.convert = function(input,params,returnType){
    switch(returnType){
      case 'f':
        var output = (parseFloat(input) * params.outputMax )/params.sourceMax;
        break;
      case 'i':
        var output = (parseInt(input) * params.outputMax)/params.sourceMax;
        break;
      }
    return output;
  }
